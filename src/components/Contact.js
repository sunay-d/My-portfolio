      ...
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <form
          ...
          <p className="leading-relaxed mb-5">
            Use the form below to contact me. Alternatively you can send me an e-mail or reach me via my social media accounts. I look forward to hearing from you. 
          </p>
          ...
          <button
            type="submit"
            className="text-black bg-orange border-0 py-2 px-6 focus:outline-none hover:bg-yellow rounded text-lg">
            Submit
          </button>
        </form>
      </div>
